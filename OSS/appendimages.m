function  [fhand]=appendimages(image1, image2,correspond1,correspond2,A)
...
hold off;
dpi = 600;
filename = strcat('H:\newpaper\moss_text\0601\', num2str(A), '.jpg');
% 使用print函数保存图像，并设置DPI
print(fhand, filename, '-djpeg', ['-r' num2str(dpi)]);
